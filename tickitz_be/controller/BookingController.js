...
const { getAllBooking, addNewBookingByFormBody, updatedBookingById, deleteBookingById, getAllBookingById } = require("../model/Booking")

module.exports={ 
    getAllBooking : async (req,res) => { //get All Booking With Join
        try {
    ...
    getAllBookingById : async (req,res) => { //get All Booking With Join
        try {
    ...
    addNewBookingByFormBody :async (req,res) =>{ //add New Booking From Body
        try {
    ...
    updatedBookingById : async(req,res)=>{//BY  Input Form Data
        try {
